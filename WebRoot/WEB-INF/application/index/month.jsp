...
<html>
	...
	var option = {
			title: {
				text:'${year}年${monthText}月份总支出<fmt:formatNumber type="number" value="${workCollect.wages+workCollect.lendMoney+workCollect.other }" pattern="0.00" maxFractionDigits="2"/>元',
				x:'center'
			},
		    tooltip : {
		        trigger: 'item',
		    ...
		    series : [
		        {
		            name: '${year}年${monthText}月份总支出<fmt:formatNumber type="number" value="${workCollect.wages+workCollect.lendMoney+workCollect.other }" pattern="0.00" maxFractionDigits="2"/>元',
		            type: 'pie',
		            radius : '55%',
		            center: ['50%', '50%'],
		            data:[
