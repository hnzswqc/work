					...
					<c:if test="${!empty orgList}">
						<c:forEach items="${orgList}" var="orgMap" varStatus="i">
							...
							<tr>
								...
								<!-- 应用 -->
								<c:if test="${empty serverList[orgUuid]}">
									<td ></td>
									<td ></td>
									<td ></td>
									<td ></td>
								...
								<c:if test="${!empty serverList[orgUuid]}">
									<c:set value="${fn:length(serverList[orgUuid])}" var="serverCount"></c:set>
									<c:forEach items="${serverList[orgUuid]}" var="serverMap" varStatus="s">
										<c:set value="${serverMap.value}" var="serverMap"></c:set>
										<td rowspan="serverCount">
											${server.serverName }
										</td>
										<td rowspan="serverCount">
											${server.serverIp }
										...
										<td rowspan="serverCount">
											...
											<!-- app -->
											<c:if test="${empty appList[server.serverUuid]}">
												<td></td>
												<td></td>
												<td></td>
												<td></td>
											...
											<c:if test="${!empty appList[server.serverUuid]}}">
													<c:forEach items="${serverList[orgUuid]}" var="appMap" varStatus="a">
