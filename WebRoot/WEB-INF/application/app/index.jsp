...
<html>
	...
	<div class="container-fluid" >
		...
		<div class="panel panel-default" >
			<div class="panel-body" style="padding-left:0px!important;">
				...
				<a href="javascript:showDetail();" class="btn btn-primary" id="searchLink">总览表</a>
	...
	<div class="panel panel-primary" >
		   <div class="panel-heading">
		      <h3 class="panel-title">
		 		<span style="color:red;font-weight:bold">${app.serverName }</span> 应用管理
 		    	<div class="close">
				...
				<thead>
					...
					<c:if test="${!empty pageBean.list}">
						<c:forEach items="${pageBean.list}" var="app" varStatus="i">
							<tr >
								<td>
									<input type="radio" name="uuid" value="${app.uuid }"/>
								</td>
								<td>
									${(pageBean.page-1)*pageBean.limit+i.index+1 }
								</td>
								<td>
									<a href="javascript:updClick('${app.uuid }');">${app.serverName }</a>
								</td>
								<td >
									${app.name }
								</td>
								...
								<td>
								  <a href="javascript:testConnection('${app.uuid }','${app.name }');"  title="测试服务是否启动"><span class="glyphicon glyphicon-refresh"/></a>&nbsp;
									  <a href="javascript:serverCommon('${app.uuid }',1);"  title="启动" ><span class="glyphicon glyphicon-play"/></a>&nbsp;
							          <a href="javascript:serverCommon('${app.uuid }',2);"  title="停止"><span class="glyphicon glyphicon-stop"/></a>&nbsp;
					          	  <a href="javascript:testUrl('${app.testUrl }');" title="测试" target="_blank"><span class="glyphicon glyphicon-share-alt"/></a>
								</td>
							</tr>
						</c:forEach>
					</c:if>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="exampleModalLabel">应用管理</h4>
      </div>
      <div class="modal-body">
        	<form class="form-horizontal" role="form" id="addForm">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" id="name" name="name" placeholder="请输入应用名称"/>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="number" class="form-control" id="port" name="port" placeholder="请输入使用端口"/>
					</div>
				</div>
				<div class="form-group">
					<label for="modelName" class="col-sm-2 control-label">检测方式</label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" id="path" name="path" placeholder="请输入部署tomcat根目录"/>
					</div>
				</div>
				<div class="form-group">
					<label for="modelName" class="col-sm-2 control-label">启动命令</label>
					<div class="col-sm-9">
						<input type="text" class="form-control" id="start" name="start" placeholder="请输入服务启动命令"/>
					</div>
				</div>
				<div class="form-group">
					<label for="modelName" class="col-sm-2 control-label">停止命令</label>
					<div class="col-sm-9">
						<input type="text" class="form-control" id="stop" name="stop" placeholder="请输入服务停止命令"/>
					</div>
				</div>
				<div class="form-group">
					<label for="modelName" class="col-sm-2 control-label">部署时间</label>
					<div class="col-sm-9">
						<input type="text" class="form-control" id="deployTime" name="deployTime" placeholder="请输入部署时间" />
					</div>
				</div>
				<div class="form-group">
					<label for="modelName" class="col-sm-2 control-label">部署版本</label>
					<div class="col-sm-9">
						<input type="text" class="form-control" id="version" name="version" placeholder="请输入部署版本" />
					</div>
				</div>
				<div class="form-group">
					<label for="modelName" class="col-sm-2 control-label">测试url</label>
					<div class="col-sm-9">
						<input type="text" class="form-control" id="testUrl" name="testUrl" placeholder="请输入测试的url链接"/>
					</div>
				</div>
				<div class="form-group">
	...
	<script type="text/javascript">
		...
		function refreshIconClick(){
			window.location.href="<%=basePath %>${menu }/index.shtml?status=${app.status}&serverUuid=${app.serverUuid}&serverName=${app.serverName}";
		}
		...
		function showDetail(){
			self.parent.location.href="<%=basePath %>${menu }/findAllApp.shtml?time="+new Date().getTime();
		}
	</script>					    
	</body>
</html>
